...
import { getPendingLoansForManager, getLoans, getProfileById } from "@/lib/mock-store"
import { Loan } from "@/lib/types"
import { FileText, Search, Eye, Clock } from "lucide-react"
import { format } from "date-fns"

export default function HighValueLoansPage() {
  ...
  const reviewedLoans = allHighValueLoans.filter(
    (loan) =>
  ...
  return (
    <DashboardLayout>
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold">High-Value Loan Applications</h1>
          <p className="text-muted-foreground mt-2">
            Review and manage loan applications of $10,000 or more
          </p>
        </div>
              ...
              <Card>
                <CardContent className="py-12 text-center">
                  ...
                  <p className="text-muted-foreground">
                    All high-value applications have been reviewed.
                  </p>
                </CardContent>
              </Card>
            ) : (
